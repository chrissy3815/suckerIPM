...
m_par <- tibble(
  ...
  egg_slope = -4.361915, # coef(egg_extended_nls)[2]
  egg_max = 41540.608025, # coef(egg_extended_nls)[1] 
  egg_infl =  935.528239, # coef(egg_extended_nls)[3]
  ## Spawning Probability - Estimated from Michaletz (2009)
  prob_spawn = 0.90,
  surv0_int = 0.2686, # coef(surv_den_exp)[1]
  surv0_decay = 0.0030 # coef(surv_den_exp)[2], # 
)
